...
class MenuViewModel : ObservableObject {
    ...
    @Published var menus = [
        Menu(type: .COFFEE, state: .AVAILABLE, name: "메뉴 이름", price: 1500),
        Menu(type: .COFFEE, state: .SOLD_OUT, name: "메뉴 이름", price: 1500),
        Menu(type: .COFFEE, state: .COMING_SOON, name: "메뉴 이름", price: 1500),
        Menu(type: .COFFEE, state: .AVAILABLE, name: "메뉴 이름", price: 1500),
        Menu(type: .COFFEE, state: .AVAILABLE, name: "메뉴 이름", price: 1500),
        Menu(type: .COFFEE, state: .AVAILABLE, name: "메뉴 이름", price: 1500),
    ]
