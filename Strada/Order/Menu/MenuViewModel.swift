...
class MenuViewModel : ObservableObject {
    ...
    @Published var favoriteMenus: [FavoriteMenu] = [
        ...
        FavoriteMenu(menu: Menu(type: .COFFEE, state: .SOLD_OUT, name: MenuName(kr: "메뉴 이름", en: "Menu Name"), price: 2000), menuOption: DrinkMenuOption(menuType: .COFFEE, temperatureType: .COLD, cupSizeType: .GRANDE, cupType: .DISPOSBLE), menuPersonalOption: DrinkMenuPersonalOption(menuType: .COFFEE, shotCount: 1, syrupCount: [:], iceCount: 1, milkCount: 0, whippedCreamCount: 0, drizzleCount: 0))]
